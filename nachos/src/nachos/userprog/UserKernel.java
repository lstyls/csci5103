...
public class UserKernel extends ThreadedKernel {
	...
	public UserKernel() {
		super();
		allocator = new FrameAllocator(Machine.processor().getNumPhysPages());
	}
...
class FrameAllocator {
	...
	public FrameAllocator(int numFrames) {
		framesAvail = numFrames;
	}
	...
	public void restore(int frames) {
		boolean intStatus = Machine.interrupt().disable();
		framesAvail += frames;
		if (waiting != null && framesAvail >= framesRequested) {
			framesAvail -= framesRequested;
			waiting.ready();
			waiting = null;
		}
		Machine.interrupt().restore(intStatus);
